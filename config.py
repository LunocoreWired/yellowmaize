...
# VRAM MAXIMIZATION & OOM PREVENTION:
# resnet50 safely ran at 6. efficientnet-b2 OOM'd at 6 due to background OS VRAM 
# usage, so it is dialed back to 4 to leave safe headroom.
