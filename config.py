...
HSV_MSV_RANGES = [
    ...
    {"name": "R2", "h": (20, 45),   "s": (30, 70),   "v": (130, 255)},  # s_min 15→30: cut midrib shine
    {"name": "R3", "h": (0,  179),  "s": (20, 35),   "v": (220, 255)},  # s_min 0→20, v_min 210→220: near-white filter
...
HSV_MLN_RANGES = [
    ...
    {"name": "R4", "h": (8,  35),   "s": (25, 45),   "v": (160, 255)},  # s_min 0→25: suppress specular highlights
